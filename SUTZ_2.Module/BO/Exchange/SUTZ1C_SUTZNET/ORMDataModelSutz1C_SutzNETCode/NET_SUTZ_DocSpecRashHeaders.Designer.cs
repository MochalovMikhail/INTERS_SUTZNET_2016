...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class NET_SUTZ_DocSpecRashHeaders : XPBaseObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		[Association(@"NET_SUTZ_DocSpecRashGoodsReferencesNET_SUTZ_DocSpecRashHeaders", typeof(NET_SUTZ_DocSpecRashGoods))]
		public XPCollection<NET_SUTZ_DocSpecRashGoods> NET_SUTZ_DocSpecRashGoods { get { return GetCollection<NET_SUTZ_DocSpecRashGoods>("NET_SUTZ_DocSpecRashGoods"); } }
	}
