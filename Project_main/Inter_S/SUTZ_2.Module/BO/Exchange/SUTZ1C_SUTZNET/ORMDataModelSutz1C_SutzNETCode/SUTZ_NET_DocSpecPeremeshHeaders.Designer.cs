...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocSpecPeremeshHeaders : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		Guid fStockRoomTo;
		public Guid StockRoomTo {
			get { return fStockRoomTo; }
			set { SetPropertyValue<Guid>("StockRoomTo", ref fStockRoomTo, value); }
		}
		...
		[Association(@"SUTZ_NET_DocSpecPeremeshGoodsReferencesSUTZ_NET_DocSpecPeremeshHeaders", typeof(SUTZ_NET_DocSpecPeremeshGoods))]
		public XPCollection<SUTZ_NET_DocSpecPeremeshGoods> SUTZ_NET_DocSpecPeremeshGoods { get { return GetCollection<SUTZ_NET_DocSpecPeremeshGoods>("SUTZ_NET_DocSpecPeremeshGoods"); } }
	}
