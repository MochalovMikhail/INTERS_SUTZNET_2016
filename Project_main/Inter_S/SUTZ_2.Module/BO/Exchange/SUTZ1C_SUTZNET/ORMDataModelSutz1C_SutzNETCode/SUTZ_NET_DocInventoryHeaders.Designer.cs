...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocInventoryHeaders : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		public byte TypeDoc {
			get { return fTypeDoc; }
			set { SetPropertyValue<byte>("TypeDoc", ref fTypeDoc, value); }
		}
		...
		[Association(@"SUTZ_NET_DocInventoryGoodsReferencesSUTZ_NET_DocInventoryHeaders", typeof(SUTZ_NET_DocInventoryGoods))]
		public XPCollection<SUTZ_NET_DocInventoryGoods> SUTZ_NET_DocInventoryGoods { get { return GetCollection<SUTZ_NET_DocInventoryGoods>("SUTZ_NET_DocInventoryGoods"); } }
	}
