...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class NET_SUTZ_DocSpecPrihodaGoods : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		NET_SUTZ_DocSpecPrihodaHeaders fHeaderID;
		[Indexed(Name=@"Index_HeaderID")]
		[Association(@"NET_SUTZ_DocSpecPrihodaGoodsReferencesNET_SUTZ_DocSpecPrihodaHeaders")]
		public NET_SUTZ_DocSpecPrihodaHeaders HeaderID {
			get { return fHeaderID; }
			set { SetPropertyValue<NET_SUTZ_DocSpecPrihodaHeaders>("HeaderID", ref fHeaderID, value); }
		}
		int fDocLineNo;
