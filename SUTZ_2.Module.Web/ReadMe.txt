...
The SUTZ_2.Module.Web project implements an ASP.NET Module. Platform-specific application elements 
...
customize Module components: referenced modules, Controllers and business classes. 
Additionally, the root folder contains Application Model difference files 
(XAFML files) that keep application settings specific for the current Module. 
Differences files can be designed with the Model Editor.  
