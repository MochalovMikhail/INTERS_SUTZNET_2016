...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocSpecPrihodaHeaders : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		public bool AllowCheckIn {
			get { return fAllowCheckIn; }
			set { SetPropertyValue<bool>("AllowCheckIn", ref fAllowCheckIn, value); }
		}
		bool fAllowMovement;
		...
		[Association(@"SUTZ_NET_DocSpecPrihodaGoodsReferencesSUTZ_NET_DocSpecPrihodaHeaders", typeof(SUTZ_NET_DocSpecPrihodaGoods))]
		public XPCollection<SUTZ_NET_DocSpecPrihodaGoods> SUTZ_NET_DocSpecPrihodaGoods { get { return GetCollection<SUTZ_NET_DocSpecPrihodaGoods>("SUTZ_NET_DocSpecPrihodaGoods"); } }
	}
