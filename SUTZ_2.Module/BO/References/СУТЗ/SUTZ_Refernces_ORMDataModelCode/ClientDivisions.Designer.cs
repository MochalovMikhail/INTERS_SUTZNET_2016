...
namespace SUTZ_2.Module.BO.References {
	...
	[Persistent(@"Table_006")]
		[System.ComponentModel.DefaultProperty("Description")]
	public partial class ClientDivisions : XPBaseObject {
		int fidd;
		[Key(true)]
		[Persistent(@"f001")]
		...
		[Persistent(@"f002")]
		[DisplayName(@"Клиент")]
		[Association(@"ClientDivisionsReferencesClients")]
		...
		public string KPP {
			get { return fKPP; }
			set { SetPropertyValue<string>("KPP", ref fKPP, value); }
		}
		string fComment;
		[Persistent(@"f008")]
