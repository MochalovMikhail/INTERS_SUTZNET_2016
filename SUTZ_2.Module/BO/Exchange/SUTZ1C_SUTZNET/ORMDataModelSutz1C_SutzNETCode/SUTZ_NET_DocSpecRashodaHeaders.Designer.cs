...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocSpecRashodaHeaders : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		Guid fStockRoomFrom;
		public Guid StockRoomFrom {
			get { return fStockRoomFrom; }
			set { SetPropertyValue<Guid>("StockRoomFrom", ref fStockRoomFrom, value); }
		}
		...
		[Association(@"SUTZ_NET_DocSpecRashodaGoodsReferencesSUTZ_NET_DocSpecRashodaHeaders", typeof(SUTZ_NET_DocSpecRashodaGoods))]
		public XPCollection<SUTZ_NET_DocSpecRashodaGoods> SUTZ_NET_DocSpecRashodaGoods { get { return GetCollection<SUTZ_NET_DocSpecRashodaGoods>("SUTZ_NET_DocSpecRashodaGoods"); } }
	}
