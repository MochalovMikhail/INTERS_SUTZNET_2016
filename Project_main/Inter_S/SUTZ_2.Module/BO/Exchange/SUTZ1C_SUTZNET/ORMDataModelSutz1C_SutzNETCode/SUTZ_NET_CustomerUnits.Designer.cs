...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_CustomerUnits : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		string fAdressSubDivision;
		[Size(150)]
		public string AdressSubDivision {
			get { return fAdressSubDivision; }
			set { SetPropertyValue<string>("AdressSubDivision", ref fAdressSubDivision, value); }
		}
		string fKppSubDivision;
		[Size(20)]
		public string KppSubDivision {
			get { return fKppSubDivision; }
			set { SetPropertyValue<string>("KppSubDivision", ref fKppSubDivision, value); }
		}
		string fComment;
		[Size(50)]
