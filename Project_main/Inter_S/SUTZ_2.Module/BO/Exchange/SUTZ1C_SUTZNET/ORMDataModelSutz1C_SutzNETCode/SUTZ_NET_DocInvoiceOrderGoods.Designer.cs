...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocInvoiceOrderGoods : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		SUTZ_NET_DocInvoiceOrderHeaders fHeaderID;
		[Indexed(Name=@"Index_HeaderID")]
		[Association(@"SUTZ_NET_DocInvoiceOrderGoodsReferencesSUTZ_NET_DocInvoiceOrderHeaders")]
		public SUTZ_NET_DocInvoiceOrderHeaders HeaderID {
			get { return fHeaderID; }
			set { SetPropertyValue<SUTZ_NET_DocInvoiceOrderHeaders>("HeaderID", ref fHeaderID, value); }
		}
		int fDocLineNo;
