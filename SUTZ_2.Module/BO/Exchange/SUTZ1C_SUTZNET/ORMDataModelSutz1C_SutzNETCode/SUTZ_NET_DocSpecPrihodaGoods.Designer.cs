...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocSpecPrihodaGoods : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		SUTZ_NET_DocSpecPrihodaHeaders fHeaderID;
		[Indexed(Name=@"Index_HeaderID")]
		[Association(@"SUTZ_NET_DocSpecPrihodaGoodsReferencesSUTZ_NET_DocSpecPrihodaHeaders")]
		public SUTZ_NET_DocSpecPrihodaHeaders HeaderID {
			get { return fHeaderID; }
			set { SetPropertyValue<SUTZ_NET_DocSpecPrihodaHeaders>("HeaderID", ref fHeaderID, value); }
		}
		int fDocLineNo;
