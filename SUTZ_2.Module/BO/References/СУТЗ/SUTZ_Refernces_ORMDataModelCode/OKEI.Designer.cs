...
namespace SUTZ_2.Module.BO.References {
	...
	[Persistent(@"Table_024")]
		[System.ComponentModel.DefaultProperty("Description")]
	public partial class OKEI : XPBaseObject {
		int fidd;
		[Key(true)]
		[Persistent(@"f001")]
		...
		string fInternationalDescription;
		[Size(20)]
		[Persistent(@"f004")]
		[DisplayName(@"Межд.наименование")]
		public string InternationalDescription {
			get { return fInternationalDescription; }
			set { SetPropertyValue<string>("InternationalDescription", ref fInternationalDescription, value); }
		}
