...
namespace SUTZ_2.Module.BO.Documents
{
    ...
    [Persistent(@"Table_151")]
    public partial class DocSpecRashodaGoods : XPBaseObject
    {
        int fidd;
        [Key(true)]
        [Persistent(@"f001")]
        ...
        DocSpecRashoda fParentID;
        [Persistent(@"f003")]
        [Association(@"GeneralXpObject1ReferencesDocSpecRashoda")]
        [DevExpress.Persistent.Base.VisibleInListView(false), DevExpress.Persistent.Base.VisibleInDetailView(false), DevExpress.Persistent.Base.VisibleInLookupListView(false)]
        public DocSpecRashoda ParentID
        {
            get { return fParentID; }
            set { SetPropertyValue<DocSpecRashoda>("ParentID", ref fParentID, value); }
        }
