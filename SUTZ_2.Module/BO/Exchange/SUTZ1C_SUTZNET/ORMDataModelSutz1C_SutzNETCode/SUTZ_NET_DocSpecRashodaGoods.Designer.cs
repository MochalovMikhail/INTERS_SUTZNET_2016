...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class SUTZ_NET_DocSpecRashodaGoods : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		SUTZ_NET_DocSpecRashodaHeaders fHeaderID;
		[Indexed(Name=@"IX_SUTZ_NET_DocSpecRashodaGoods", Unique=true)]
		[Association(@"SUTZ_NET_DocSpecRashodaGoodsReferencesSUTZ_NET_DocSpecRashodaHeaders")]
		public SUTZ_NET_DocSpecRashodaHeaders HeaderID {
			get { return fHeaderID; }
			set { SetPropertyValue<SUTZ_NET_DocSpecRashodaHeaders>("HeaderID", ref fHeaderID, value); }
		}
		int fDocLineNo;
