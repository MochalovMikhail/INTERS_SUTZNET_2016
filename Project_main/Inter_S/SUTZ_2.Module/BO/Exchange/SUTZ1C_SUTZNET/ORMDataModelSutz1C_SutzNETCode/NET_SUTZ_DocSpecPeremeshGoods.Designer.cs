...
namespace SUTZ_2.Module.BO.Exchange.SUTZ1C_SUTZNET {
	...
	public partial class NET_SUTZ_DocSpecPeremeshGoods : XPLiteObject {
		int frow_id;
		[Key(true)]
		public int row_id {
			get { return frow_id; }
		...
		NET_SUTZ_DocSpecPeremeshHeaders fHeaderID;
		[Indexed(Name=@"Index_HeaderID")]
		[Association(@"NET_SUTZ_DocSpecPeremeshGoodsReferencesNET_SUTZ_DocSpecPeremeshHeaders")]
		public NET_SUTZ_DocSpecPeremeshHeaders HeaderID {
			get { return fHeaderID; }
			set { SetPropertyValue<NET_SUTZ_DocSpecPeremeshHeaders>("HeaderID", ref fHeaderID, value); }
		}
		int fDocLineNo;
